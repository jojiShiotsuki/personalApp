...
export default function TaskList({ tasks, onStatusChange, onTaskClick, onDelete, onSnooze, isUpdating, searchQuery, selectedTaskIds, onToggleSelect }: TaskListProps) {
  if (tasks.length === 0) {
    return (
