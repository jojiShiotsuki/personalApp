...
export default function ContentForm({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-2xl w-full max-w-3xl mx-4 max-h-[90vh] overflow-y-auto">
        {/* Header */}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          {/* Date */}
          <div>
            <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Content Date *</label>
            <input
              type="date"
              ...
              className="w-full border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-white rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-shadow"
              required
              disabled={isLoading}
            />
          </div>
          ...
          {/* Script/Caption */}
          <div>
            <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Script / Caption</label>
            <RichTextEditor
          ...
          {/* Platforms */}
          <div>
            <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">Platforms</label>
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      isSelected
                        ? "bg-blue-50 dark:bg-blue-900/30 border-blue-500 dark:border-blue-400 text-blue-700 dark:text-blue-400 shadow-sm"
                    ...
                    disabled={isLoading}
                  >
                    <Icon className={cn("w-4 h-4", isSelected ? "text-blue-600 dark:text-blue-400" : "text-gray-400 dark:text-gray-500")} />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Editing Style */}
            <div>
              <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Editing Style</label>
              <select
            ...
            {/* Music/Audio */}
            <div>
              <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Music / Audio</label>
              <input
                type="text"
          ...
          {/* Editing Notes */}
          <div>
            <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Editing Notes</label>
            <textarea
          ...
          {/* Thumbnail Reference */}
          <div>
            <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Thumbnail Reference</label>
            <input
              type="text"
          ...
          {/* Production Notes */}
          <div>
            <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Production Notes</label>
            <textarea
          ...
          {/* Action Buttons */}
          <div className="flex gap-3 justify-between border-t border-gray-200 dark:border-gray-700 pt-6 sticky bottom-0 bg-white dark:bg-gray-800">
            <div>
              {isEditMode && onDelete && (
                <button
                  type="button"
                  ...
                  disabled={isLoading}
                  className="px-4 py-2 border border-red-200 dark:border-red-800 text-red-600 dark:text-red-400 rounded-lg hover:bg-red-50 dark:hover:bg-red-900/30 disabled:opacity-50 flex items-center gap-2 transition-colors"
                >
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="px-4 py-2 bg-blue-600 dark:bg-blue-500 text-white rounded-lg hover:bg-blue-700 dark:hover:bg-blue-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors shadow-sm"
              >
