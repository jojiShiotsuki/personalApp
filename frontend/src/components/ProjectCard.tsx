...
export default function ProjectCard({ project }: ProjectCardProps) {
  ...
  return (
    <div
      ...
      className="group bg-white rounded-xl shadow-sm border border-gray-200 p-5 hover:shadow-md hover:border-gray-300 transition-all duration-300 hover:-translate-y-1 cursor-pointer"
    >
      {/* Header */}
