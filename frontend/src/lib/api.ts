...
export const autoresearchApi = {
  ...
  generateFollowup: async (prospectId: number): Promise<{ subject: string; body: string; loom_script?: string; word_count: number; step_number: number; follow_up_number: number; model: string; cost_usd: number }> => {
